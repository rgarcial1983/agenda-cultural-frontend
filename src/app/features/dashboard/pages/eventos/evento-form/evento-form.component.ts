          ...
          <form [formGroup]="eventoForm" (ngSubmit)="onSubmit()">
            ...
            <mat-form-field appearance="outline" class="full-width">
              ...
              <mat-select formControlName="categorias" multiple required>
                ...
                <mat-option value="Visita Guiada">Visita Guiada</mat-option>
                ...
                <mat-option value="Música Clásica">Música Clásica</mat-option>
                <mat-option value="Artesanía">Artesanía</mat-option>
                <mat-option value="Festival">Festival</mat-option>
                <mat-option value="Música Sacra">Música Sacra</mat-option>
              </mat-select>
              <mat-error *ngIf="eventoForm.get('categorias')?.hasError('required')">
                Las categorías son requeridas
              </mat-error>
            </mat-form-field>

            <div class="form-actions">
              <button mat-button type="button" routerLink="/admin/dashboard/eventos">Cancelar</button>
